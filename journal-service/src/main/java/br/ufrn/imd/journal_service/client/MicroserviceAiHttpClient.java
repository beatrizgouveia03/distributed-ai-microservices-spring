...
public interface MicroserviceAiHttpClient {
    ...
    String advise(
        @RequestBody JournalEntry prompString,
        @RequestParam(name = "id", required = false) String id
    );

    public default String fallbackMicroserviceAi(JournalEntry prompt, String id, Throwable throwable){
